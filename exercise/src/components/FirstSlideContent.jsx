    ...
    return (
        <div className='text-gray-800'>
            <div className="max-w-[800px] mt-[-100px] w-full h-screen mx-auto flex flex-col justify-center">
                <p className='p-1 text-2xl font-montserrat font-semibold md:py-6 HP:text-3xl'>WELCOME TO <br /><Typed strings={['OTTER','Otter','OTTER']} loop typeSpeed={120} backSpeed={120} className='uppercase text-4xl font-bold HP:text-5xl'/></p>
